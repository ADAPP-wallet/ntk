...
int64 nChainStartTime = 1597136819;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Aug 11 2020, Start for NTKcoins.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x6eba05cd860757dcdea0c051b9e676fe3f01c11a2411aafae32525f8bacc620c"));
